...
type Cors struct {
	...
	WebsocketOrigins string `json:"websocket_origins" yaml:"websocket_origins"` // WebSocket CORS origins (default: "*")
}
...
func (c *Cors) GetWebsocketOrigins() string {
	if c.WebsocketOrigins == "" {
		return "*"
	}
	return c.WebsocketOrigins
}
