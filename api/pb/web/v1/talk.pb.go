...
func (x *TalkSessionDeleteRequest) GetReceiverId() int32 {
	if x != nil {
		return x.ReceiverId
	}
	return 0
...
func (x *TalkSessionTopRequest) GetReceiverId() int32 {
	if x != nil {
		return x.ReceiverId
	}
	return 0
...
func (x *TalkSessionDetailRequest) GetReceiverId() int32 {
	if x != nil {
		return x.ReceiverId
	}
	return 0
...
const file_web_v1_talk_proto_rawDesc = "" +
	...
	"\vreceiver_id\x18\x03 \x01(\x05B\x04\xe2A\x01\x02R\n" +
	"receiverId\x12\x1b\n" +
	...
	"\bmsg_text\x18\f \x01(\tB\x04\xe2A\x01\x02R\amsgText\x12#\n" +
	"\n" +
	"updated_at\x18\r \x01(\tB\x04\xe2A\x01\x02R\tupdatedAt\"l\n" +
	"\x18TalkSessionDeleteRequest\x12&\n" +
	"\ttalk_mode\x18\x01 \x01(\x05B\t\xbaH\x06\x1a\x040\x010\x02R\btalkMode\x12(\n" +
	"\vreceiver_id\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\n" +
	"receiverId\"\x1b\n" +
	"\x19TalkSessionDeleteResponse\"\x8c\x01\n" +
	...
	"\x06is_top\x18\x01 \x01(\x05B\x04\xe2A\x01\x02R\x05isTop\"\x90\x01\n" +
	...
	"\n" +
	"is_disturb\x18\x01 \x01(\x05B\x04\xe2A\x01\x02R\tisDisturb\"l\n" +
