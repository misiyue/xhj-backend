...
func (r *MerchantHmOrder) ApplyNotifyAndMarkOrderPaid(ctx context.Context, orderId string, restate int, payTimeUnix int) error {
	orderId = strings.TrimSpace(orderId)
	if orderId == "" {
		return errors.New("order_id empty")
	}
