...
type OrganizePost struct {
	...
	Sort       int       `gorm:"column:sort;index:idx_position_status_sort,priority:2" json:"sort"`     // 显示顺序
	Status     int       `gorm:"column:status;index:idx_position_status_sort,priority:1" json:"status"` // 状态[1:正常;2:停用;]
